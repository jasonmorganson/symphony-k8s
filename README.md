...
- `../arrusted-development/WORKFLOW.md` canonical workflow source (override with `SYMPHONY_WORKFLOW_FILE`)
...
- requires the canonical `arrusted-development/WORKFLOW.md` checkout, rather than maintaining a Kubernetes-specific fork
